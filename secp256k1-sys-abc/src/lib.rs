...
extern "C" {
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdh_hash_function_default")]
    pub static secp256k1_ecdh_hash_function_default: EcdhHashFn;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_nonce_function_rfc6979")]
    pub static secp256k1_nonce_function_rfc6979: NonceFn;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_nonce_function_default")]
    pub static secp256k1_nonce_function_default: NonceFn;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_nonce_function_bip340")]
    pub static secp256k1_nonce_function_bip340: SchnorrNonceFn;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_no_precomp")]
    pub static secp256k1_context_no_precomp: *const Context;

    // Contexts
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_destroy")]
    pub fn secp256k1_context_preallocated_destroy(cx: *mut Context);

    // Signatures
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_signature_parse_der")]
    pub fn secp256k1_ecdsa_signature_parse_der(cx: *const Context, sig: *mut Signature,
                                               input: *const c_uchar, in_len: size_t)
                                               -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_signature_parse_compact")]
    pub fn secp256k1_ecdsa_signature_parse_compact(cx: *const Context, sig: *mut Signature,
                                                   input64: *const c_uchar)
                                                   -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "ecdsa_signature_parse_der_lax")]
    pub fn ecdsa_signature_parse_der_lax(cx: *const Context, sig: *mut Signature,
                                         input: *const c_uchar, in_len: size_t)
                                         -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_signature_serialize_der")]
    pub fn secp256k1_ecdsa_signature_serialize_der(cx: *const Context, output: *mut c_uchar,
                                                   out_len: *mut size_t, sig: *const Signature)
                                                   -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_signature_serialize_compact")]
    pub fn secp256k1_ecdsa_signature_serialize_compact(cx: *const Context, output64: *mut c_uchar,
                                                       sig: *const Signature)
                                                       -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_signature_normalize")]
    pub fn secp256k1_ecdsa_signature_normalize(cx: *const Context, out_sig: *mut Signature,
                                               in_sig: *const Signature)
                                               -> c_int;

    // Secret Keys
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_seckey_verify")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_privkey_negate")]
    pub fn secp256k1_ec_privkey_negate(cx: *const Context,
                                       sk: *mut c_uchar) -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_seckey_negate")]
    pub fn secp256k1_ec_seckey_negate(cx: *const Context,
                                      sk: *mut c_uchar) -> c_int;

    #[deprecated(since = "0.2.0",note = "Please use the secp256k1_ec_seckey_tweak_add function instead")]
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_privkey_tweak_add")]
    pub fn secp256k1_ec_privkey_tweak_add(cx: *const Context,
                                          sk: *mut c_uchar,
                                          tweak: *const c_uchar)
                                          -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_seckey_tweak_add")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_privkey_tweak_mul")]
    pub fn secp256k1_ec_privkey_tweak_mul(cx: *const Context,
                                          sk: *mut c_uchar,
                                          tweak: *const c_uchar)
                                          -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_seckey_tweak_mul")]
    pub fn secp256k1_ec_seckey_tweak_mul(cx: *const Context,
                                        sk: *mut c_uchar,
                                        tweak: *const c_uchar)
                                        -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_keypair_sec")]
    pub fn secp256k1_keypair_sec(cx: *const Context,
                                 output_seckey: *mut c_uchar,
                                 keypair: *const KeyPair)
                                 -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_keypair_pub")]
...
extern "C" {
    // Contexts
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_size")]
    pub fn secp256k1_context_preallocated_size(flags: c_uint) -> size_t;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_create")]
    pub fn secp256k1_context_preallocated_create(prealloc: *mut c_void, flags: c_uint) -> *mut Context;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_clone_size")]
    pub fn secp256k1_context_preallocated_clone_size(cx: *const Context) -> size_t;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_clone")]
    pub fn secp256k1_context_preallocated_clone(cx: *const Context, prealloc: *mut c_void) -> *mut Context;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_randomize")]
    pub fn secp256k1_context_randomize(cx: *mut Context,
                                       seed32: *const c_uchar)
                                       -> c_int;
    // Pubkeys
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_parse")]
    pub fn secp256k1_ec_pubkey_parse(cx: *const Context, pk: *mut PublicKey,
                                     input: *const c_uchar, in_len: size_t)
                                     -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_serialize")]
    ...
    // EC
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_create")]
    pub fn secp256k1_ec_pubkey_create(cx: *const Context, pk: *mut PublicKey,
                                      sk: *const c_uchar) -> c_int;


    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_negate")]
    pub fn secp256k1_ec_pubkey_negate(cx: *const Context,
                                      pk: *mut PublicKey) -> c_int;


    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_tweak_add")]
    pub fn secp256k1_ec_pubkey_tweak_add(cx: *const Context,
                                         pk: *mut PublicKey,
                                         tweak: *const c_uchar)
                                         -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_tweak_mul")]
    pub fn secp256k1_ec_pubkey_tweak_mul(cx: *const Context,
                                         pk: *mut PublicKey,
                                         tweak: *const c_uchar)
                                         -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ec_pubkey_combine")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdh")]
    ...
    // ECDSA
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_verify")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_ecdsa_sign")]
    ...
    // Bitcoin (BTC) Schnorr Signatures
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_schnorrsig_sign")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_schnorrsig_verify")]
    ...
    // ABC Schnorr Signatures
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_schnorr_sign")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_schnorr_verify")]
    ...
    // Extra keys
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_keypair_create")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_xonly_pubkey_parse")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_xonly_pubkey_serialize")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_xonly_pubkey_from_pubkey")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_xonly_pubkey_tweak_add")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_keypair_xonly_pub")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_keypair_xonly_tweak_add")]
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_xonly_pubkey_tweak_add_check")]
...
mod fuzz_dummy {
    ...
    extern "C" {
        #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_size")]
        fn rust_secp256k1_context_preallocated_size(flags: c_uint) -> size_t;
        #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_create")]
        fn rust_secp256k1_context_preallocated_create(prealloc: *mut c_void, flags: c_uint) -> *mut Context;
        #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "secp256k1_context_preallocated_clone")]
        fn rust_secp256k1_context_preallocated_clone(cx: *const Context, prealloc: *mut c_void) -> *mut Context;
    }
    ...
    pub unsafe fn secp256k1_context_preallocated_size(flags: c_uint) -> size_t {
        assert!(rust_secp256k1_context_preallocated_size(flags) + std::mem::size_of::<c_uint>() <= CTX_SIZE);
        CTX_SIZE
    }
    ...
    pub unsafe fn secp256k1_context_preallocated_create(prealloc: *mut c_void, flags: c_uint) -> *mut Context {
        ...
        while have_ctx != HAVE_CONTEXT_DONE {
            if have_ctx == HAVE_CONTEXT_NONE {
                ...
                if have_ctx == HAVE_CONTEXT_NONE {
                    assert!(rust_secp256k1_context_preallocated_size(SECP256K1_START_SIGN | SECP256K1_START_VERIFY) + std::mem::size_of::<c_uint>() <= CTX_SIZE);
                    assert_eq!(rust_secp256k1_context_preallocated_create(
    ...
    pub unsafe fn secp256k1_context_preallocated_clone(cx: *const Context, prealloc: *mut c_void) -> *mut Context {
        ...
        rust_secp256k1_context_preallocated_clone(cx, prealloc)
    }
    ...
    pub unsafe fn secp256k1_schnorr_verify(
        ...
        check_context_flags(ctx, SECP256K1_START_VERIFY);
        let sig_sl = slice::from_raw_parts(sig64 as *const u8, 64);
    ...
    pub unsafe fn secp256k1_schnorr_sign(
        ...
        check_context_flags(ctx, SECP256K1_START_SIGN);
        // Check context is built for signing
        let mut pubkey = PublicKey::new();
        secp256k1_ec_pubkey_create(ctx, &mut pubkey, seckey);
        // Sign
        let sig_sl = slice::from_raw_parts_mut(sig64 as *mut u8, 64);
        let msg_sl = slice::from_raw_parts(msghash32 as *const u8, 32);
        sig_sl[..32].copy_from_slice(msg_sl);
        sig_sl[32..].copy_from_slice(&pubkey[..32]);
        1
    }
